...
require (
	code.byted.org/ad/union_common v1.1.1
	code.byted.org/device/bddid_mapping v1.7.12
	code.byted.org/dp/bytedance_encdec v0.0.0-20200513140943-4959f84bf37a
	code.byted.org/golf/logger v0.0.0-20160929064355-0a0db464847e
	code.byted.org/gopkg/thrift v1.13.0
	code.byted.org/inf/sarama v1.4.19
	code.byted.org/kite/kitex v1.10.6
	code.byted.org/kite/kitutil v3.8.4+incompatible
	code.byted.org/middleware/hertz v1.10.0
	code.byted.org/ucenter/user_identity_token_lib v1.2.32
	code.byted.org/volcengine/volc-bypass-golang v1.1.29
	git.byted.org/goutil v0.0.0-20180121101007-82f9a7ddff35
	...
	github.com/volcengine/apminsight-server-sdk-go v1.3.18
)
